...
export class NGLViewerView extends HTMLBoxView {
    ...
    //     this._stage = this.el.firstElementChild
    //     this._stage.addEventListener("click", () => {this.model.extension+="!clicked! "; console.log(this.model.extension)}, false)
    // }
}
...
export class NGLViewer extends HTMLBox {
    ...
    static __module__ = "easyCrystallography.graphics.bokeh_extensions.ngl_viewer"
