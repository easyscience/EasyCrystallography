...
extension._imports["ngl_viewer"] = "easyCrystallography.graphics.bokeh_extensions.ngl_viewer"
...
class NGLViewer(PaneBase):
    ...
    _model_module = "easyCrystallography.graphics.bokeh_extensions.ngl_viewer"
    _model = "NGLViewer"
